  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        localStorage.setItem("konverpro_token", data.token);
      ...
      <div className="bg-white w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 rounded-3xl shadow-2xl overflow-hidden min-h-[520px] animate-fadeSlideUp">
        ...
        <div className="bg-[#031f37] p-10 text-white flex flex-col justify-between relative overflow-hidden hidden md:flex">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-200 text-xs font-medium tracking-widest uppercase mb-6">
              Enterprise Portal
            </p>
            <p className="text-sm text-blue-100 leading-relaxed opacity-80">
              Sistem manajemen konversi SKS berbasis AI dengan Role-Based Access
              Control tingkat tinggi.
            </p>
          </div>
          <div className="relative z-10 mt-8">
            <p className="text-xs font-bold uppercase tracking-widest text-blue-300 text-[9px]">
              Akses internal pengguna terdaftar
            </p>
          </div>
        </div>
        ...
        <div className="p-10 flex flex-col justify-center bg-white relative">
          <h2 className="text-2xl font-heading font-bold text-[#031f37] mb-1.5">
            Selamat Datang
          </h2>
          <p className="text-sm text-slate-400 mb-6 font-medium">
            Silakan masuk ke akun workspace Anda.
          </p>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            >
              {loading ? (
                ...
                <>
                  Masuk Sistem <ArrowRight size={18} weight="bold" />
                </>
              )}
            </button>
          </form>
